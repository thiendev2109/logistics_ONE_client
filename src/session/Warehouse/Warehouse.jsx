...
import { accountAdmin, adminToken, allWarehouses } from "../../redux/selector";
import {
  createWarehouse,
  deleteWarehouse,
  getWarehouses,
  updateWarehouse,
} from "../../services/warehouseRequest";
...
const Warehouse = (props) => {
  ...
  const warehouses = useSelector(allWarehouses);
  ...
  return (
    <div className="warehouse-session">
      <p className="warehouse-title">Warehouse management</p>
      <div className="">
        <Button
          onClick={showModal}
          type="primary"
